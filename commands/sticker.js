...
async function stickerCommand(sock, chatId, message) {
    ...
    if (!mediaMessage) {
        await sock.sendMessage(chatId, { 
            text: 'පොටෝ එකකට හරි වීඩියෝ එකකට හරි .sticker රිප්ලයි කරන්න.',
            contextInfo: {
                forwardingScore: 999,
                isForwarded: false,
    ...
    try {
        ...
        const json = {
            ...
            'sticker-pack-name': settings.packname || 'NIMA V4',
            'emojis': ['🤖']
        };
        ...
        console.error('විධානයේ දෝෂයකි:', error);
        await sock.sendMessage(chatId, { 
            text: '.',
            contextInfo: {
                forwardingScore: 999,
